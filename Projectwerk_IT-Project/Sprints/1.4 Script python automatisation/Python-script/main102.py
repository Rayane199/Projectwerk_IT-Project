...
# Définition de la fonction calculer_info_reseau
...
# Fonction configurer_reseau (non modifiée)
...
# Fonction afficher_configuration (modifiée pour inclure les nouvelles informations demandées)
...
# Fonctions de validation (non modifiées)
