...
nb_commutateurs = int(input("Entrez le nombre de commutateurs : "))
nb_switchs = int(input("Entrez le nombre de switchs : "))
nb_access_points = int(input("Entrez le nombre d'access points : "))
...
numeros_commutateurs = [f"Commutateur {i}" for i in range(1, nb_commutateurs + 1)]
numeros_switchs = [f"Switch {i}" for i in range(1, nb_switchs + 1)]
numeros_access_points = [f"Access Point {i}" for i in range(1, nb_access_points + 1)]
